...
```
This is a Netflix clone which is a built to replicate the UI design of Netflix.
This is not a product of Netflix, and has been built just as a personal project.
